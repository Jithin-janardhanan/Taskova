...
class _BusinessFormPageState extends State<BusinessFormPage> {
  ...
  Future<void> _fetchPostcodeSuggestions() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          _postalCodeSuggestions = _generateFallbackPostcodes(query);
        });
      }
    } catch (e) {
  ...
  List<String> _generateFallbackPostcodes(String query) {
    ...
    final allPostcodes = [
      'SW1A 1AA', 'W1A 0AX', 'EC1A 1BB', 'M1 1AE', 'B33 8TH', 
      'CR2 6XH', 'DN55 1PT', 'L1 1QW', 'SE1 7GP', 'W1T 1UQ',
    ];
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Postcode input with dynamic suggestions
                  Column(
                    children: [
                      TextFormField(
                        controller: _postcodeController,
                        decoration: InputDecoration(
                          labelText: appLanguage.get('postcode') ?? 'Postcode',
                          hintText: appLanguage.get('enter_postcode') ?? 'Enter postcode',
                          prefixIcon: const Icon(
                            Icons.location_city,
                            color: AppColors.secondaryBlue,
                          ),
                            ...
                            : IconButton(
                                ...
                                onPressed: () {
                                  if (_postcodeController.text.isNotEmpty) {
                                    ...
                                    _showSnackbar(
                                        appLanguage.get('please_enter_postcode') ??
                                        'Please enter a postcode first',
                                        true);
                                  }
                                },
                      ...
                      // Suggestion list
                      if (_postalCodeSuggestions.isNotEmpty)
                        Container(
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              return ListTile(
                                ...
                                onTap: () {
                                  // Select the postcode
                                  _postcodeController.text = _postalCodeSuggestions[index];
                                  
                                  // Fetch coordinates
                                  _fetchCoordinatesFromPostcode(_postalCodeSuggestions[index]);
